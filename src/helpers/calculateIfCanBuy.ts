...
export const calculatePurchaseValue = (products: Weapon[] | Helmet[] | Armor[] | Boot[] | Ring[] | Artifact[] | Shield[] | Ingredient[] | (Weapon | Helmet | Armor | Boot | Ring | Artifact | Shield | Ingredient)[], quantity: number) => {
    let value = 0;
