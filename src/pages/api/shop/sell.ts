...
const updatePlayerInventory = (player: Player, product: Product) => {
    switch(product.type) {
        case 'weapon':
            ...
            player.inventory.weapons = [...player.inventory.weapons.filter((item) => item._id !== product._id)] as Weapon[];
        ...
        case 'shield':
            ...
            player.inventory.shields = [...player.inventory.shields.filter((item) => item._id !== product._id)] as Shield[];
        ...
        case 'helmet':
            ...
            player.inventory.helmets = [...player.inventory.helmets.filter((item) => item._id !== product._id)] as Helmet[];
        ...
        case 'armor':
            ...
            player.inventory.armors = [...player.inventory.armors.filter((item) => item._id !== product._id)] as Armor[];
        ...
        case 'boot':
            ...
            player.inventory.boots = [...player.inventory.boots.filter((item) => item._id !== product._id)] as Boot[];
        ...
        case 'ring':
            ...
            player.inventory.rings = [...player.inventory.rings.filter((item) => item._id !== product._id)] as Ring[];
        ...
        case 'artifact':
            ...
            player.inventory.artifacts = [...player.inventory.artifacts.filter((item) => item._id !== product._id)] as Artifact[];
